...
{
    *this = original;
    std::cout << "ClapTrap copy constructor here" << std::endl;
}

ClapTrap :: ClapTrap (void): _hitpoints(10), _energy_points(10), _attack_damage(0)
{

    std::cout << "ClapTrap default constructor here" << std::endl;
}

ClapTrap :: ~ClapTrap (void)
{
    std::cout << "ClapTrap destructor here" << std::endl;

}

ClapTrap :: ClapTrap (string name) : _hitpoints(10), _energy_points(10), _attack_damage(0), _name(name)
{
    std::cout << "ClapTrap name constructor here" << std::endl;
}
